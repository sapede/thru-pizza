...
private val LightColorPalette = JetsnackColors(
    ...
    error = FunctionalRed,
    gradient6_1 = listOf(Shadow10, Ocean9, Shadow8, Ocean9, Shadow10),
    gradient6_2 = listOf(Rose7, Lavender6, Rose5, Lavender6, Rose7),
    gradient3_1 = listOf(Shadow5, Ocean6, Shadow7),
    gradient3_2 = listOf(Rose5, Lavender6, Rose7),
    gradient2_1 = listOf(Shadow7, Shadow11),
    gradient2_2 = listOf(Ocean6, Shadow6),
    gradient2_3 = listOf(Lavender6, Rose5),
    tornado1 = listOf(Shadow7, Ocean6),
    isDark = false
)
