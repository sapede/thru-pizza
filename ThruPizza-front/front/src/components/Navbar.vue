<template>
    <v-app-bar app color="white" flat>
        <v-badge color="#D5F0DB" dot>
            <v-img src="../../public/1.png" contain width="60"></v-img>
        </v-badge>
        <v-toolbar-title class="ml-4">
            <span class="green--text">e</span><strong>VrumVrumPizza</strong>
        </v-toolbar-title>
        <v-spacer></v-spacer>
        ...
        <span class="grey--text d-nome d-sm-flex">Hello, <strong>Matuti</strong></span>
